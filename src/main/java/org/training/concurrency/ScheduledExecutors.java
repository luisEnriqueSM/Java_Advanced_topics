...
public class ScheduledExecutors {
    ...
    public static void scheduleWithFixedDelay(){
        ...
        final long INITIAL_DELAY = 200, WAIT_PERIOD_AFTER_PREVIOUS_TASK_FINISHED = 300;
    ...
    public static void scheduleAtFixedRate(){
        System.out.println("Start...");
        // Assuming 50 msecs is the time after the initial delay to wait to start the next task and so forth
        ...
        //      task 4 starts at 2000msecs + (500 msecs)* 2 = 3500msecs and so on...
