...
public class UsingQueues {
    ...
    public static void linkedListQueue(){
        ...
        // remove() - Retrieves and removes the head of this queue (throws if queue empty)
        // poll() - Retrieves and removes the head of this queue (return null if this queue is empty)
    ...
    public static void arrayDeque(){
        // Deque = "doubly ended queue". Supports elements insertion/removal at both ends.
        ...
        numbers.addFirst(2); // Head -> [2, 1] <-Tail - exception throw if deque is full
