...
public class UsingMaps {
    ...
    public static void main(String[] args){
        ...
        for(Integer age : map.values()){ // sort is by keys
            System.out.println(age); // 33, 17, 21
        }
        ...
        // Set<Map.Entry<K,V> entrySet() - Map.Entry encapsulate a key-value pair.
        // go from a Map to Set (an official Collection)
        // Chris -> 33
        // John -> 18
        // Mary -> 21
        ...
        // replace the value by the given key
        ...
        //     replaceAll(BiFunction<K, V, V> fn) - note the return type is of type V also (should return same type like the second param)
