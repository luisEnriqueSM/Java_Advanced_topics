...
public class UsingLists {
    ...
    public static void factoryMethods() {
        ...
        List<String> asList = Arrays.asList(array); // 'array' and 'asList' are now 'backend'
    ...
    public static void stack(){
        ...
        // Using the Stack type as the reference type so we get access to the push(), pop() and peak() method.
