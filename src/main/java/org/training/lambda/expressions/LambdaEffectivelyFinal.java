...
public class LambdaEffectivelyFinal {
    ...
    public static void main(String[] args){
        ...
        // Lambdas take a snapshot/pictures of local variables; these local
        // variables MUST NOT change. Only setting up lambda here.
        Predicate<String> lambda = s -> {
            // x++;
            new LambdaEffectivelyFinal().name = "Nico"; // instance/class vars are ok
        ...
        new LambdaEffectivelyFinal().name = "Goku"; // instance/class vars are ok
