...
public class MethodReferenceType {
    ...
    public static void main(String[] args){
        ...
        System.out.println(lowerL.get()); // mr. luis
        System.out.println(lowerMr.get()); // mr. luis
    ...
    public static void unboundMethodReferences(){
        ...
        System.out.println(upperL.apply("luis"));
        System.out.println(upperMr.apply("luis"));
        ...
        System.out.println(concatL.apply("Luis ", "Enrique"));

        // 1st parameter is used for executing the instance method
        // "Luis".concat("Enrique")
        System.out.println(concatMR.apply("Luis ", "Enrique"));
    }
    ...
    public static void constructorMethodReferences(){
        ...
        Function<Integer, List<String>> alL = x -> new ArrayList<>();
